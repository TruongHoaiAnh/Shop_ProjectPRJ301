                ...
                <div class="row gx-lg-5 align-items-center mb-5">
                    <div class="col-lg-6 mb-5 mb-lg-0" style="z-index: 10">
                        <h1 class="fw-bold"  style="color: hsl(218, 81%, 75%)">
                            GOGI PUMJIL
                            <br>
                            <span class="my-5 display-5 ls-tight" style="color: hsl(218, 81%, 95%); font-size: 28px; font-weight: bold"> Nơi có những món ăn chuẩn vị </span>
                        </h1>
                        <br />
                            ...
                            <div class="card-body p-4 p-md-5">
                                <form method="post" enctype="multipart/form-data" action="/product"  id="productForm">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input required type="number" name="productPrice" class="form-control" value="${productToUpdate.price}"/>
                                    </div>
